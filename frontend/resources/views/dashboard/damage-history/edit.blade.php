...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Damage History /</span> Edit</h4>
        <!-- Basic Layout -->
                        ...
                        <form id="form">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="inventory" placeholder="Input Inventory"
                                    value="{{ $data['inventory']['guid'] }} - {{ $data['inventory']['inventory_name'] }}"
                                    required />
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="damage-date" placeholder="Input Damage Date"
                                    required value="{{ $data['date_of_damage'] }}" />
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3" id="last-user-block">
                                ...
                                <input id="last-user-tag" name="last-user-tag" class="form-control"
                                    placeholder="Select User" value="{{ $userLast }}">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label class="form-label" for="basic-default-fullname">Repair Vendor</label>
                                <input type="text" class="form-control" id="vendor" placeholder="Input Vendor"
                                    value="{{ $data['repair_vendor'] }}" />
                            </div>
                            <div class="mb-3" id="user-repair-block">
                                ...
                                <input id="user-repair-tag" name="user-repair-tag" class="form-control"
                                    placeholder="Select User" value="{{ $userRepair }}">
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="repair-done-date"
                                    ...
                                    value="{{ $data['completion_date_of_repair'] }}" />
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" inputmode="numeric" class="format form-control" id="repair-cost"
                                    placeholder="Input Repair Cost" value="{{ $data['repair_cost'] }}" />
                            </div>
