...
<h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Inventory /</span> Category
    </h4>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#table-data').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "{{ env('URL_API') }}/api/v1/category/datatable/",
                "type": "GET",
            ...
            "columns": [
                ...
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        return '<a href="/category/edit/' + data['guid'] +
            ...
            buttons: [{
                ...
                action: function(e, dt, node, config) {
                    window.location = 'category/insert';
                }
            }],
            responsive: {
                details: {
        ...
        }), $("div.head-label").html('<h5 class="card-title mb-0">Data Category</h5>');
        ...
        $('#delete-form').on('submit', function(e) {
            ...
            $.ajax({
                type: "DELETE",
                url: "{{ env('URL_API') }}/api/v1/category/" + guid,
                data: {
