...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Inventory / Item / {{ $data['data']['inventory']['inventory_name'] }} / Damage History /</span> Detail
    </h4>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <ul class="list-unstyled mb-4 mt-3">
                                <li class="d-flex align-items-center mb-3"><i class="fa fa-tag"></i><span class="fw-bold mx-2">Inventory</span>
    ...
    @else
        <?php
            $purchase_date = date('d F Y', strtotime($data['data']['date_of_damage']));
            echo "<span>$purchase_date</span>";
        ?>
    @endif
</li>
                                <li class="d-flex align-items-center mb-3"><i class="fa fa-calendar"></i><span class="fw-bold mx-2">Description</span>
                                ...
                                <li class="d-flex align-items-center mb-3"><i class="fa fa-money"></i><span class="fw-bold mx-2">Last User</span>
    ...
    @else
        <?php
            $purchase_date = date('d F Y', strtotime($data['data']['completion_date_of_repair']));
            echo "<span>$purchase_date</span>";
        ?>
    @endif
</li>

                                <li class="d-flex align-items-center mb-3"><i class="fa fa-pencil-square-o"></i><span class="fw-bold mx-2">Repair Vendor</span>
                                ...
                                <li class="d-flex align-items-center mb-3"><i class="fa fa-user"></i><span class="fw-bold mx-2">User Repair</span>
                                ...
                                <li class="d-flex align-items-center mb-3"><i class="fa fa-map-marker"></i><span class="fw-bold mx-2">Repair Cost</span>
                                    @if (empty($data['data']['repair_cost']))
                                    <span>-</span>
                                    @else
                                    <span class="format">{{ $data['data']['repair_cost'] }}</span>
                                    @endif
                                </li>
                                <li class="d-flex align-items-center mb-3">
