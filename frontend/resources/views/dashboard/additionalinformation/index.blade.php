...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light"></span> Additional Information
        </h4>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#table-data').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url": "{{ env('URL_API') }}/api/v1/additionalinformation/datatable",
                    "type": "GET",
                ...
                "columns": [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            return '<a href="/additionalinformation/edit/' + data['guid'] +
                ...
                buttons: [{
                    ...
                    action: function(e, dt, node, config) {
                        window.location = 'additionalinformation/insert';
                    }
                }],
            }), $("div.head-label").html('<h5 class="card-title mb-0">Additional Information Data</h5>');
            ...
            $('#delete-form').on('submit', function(e) {
                ...
                $.ajax({
                    type: "DELETE",
                    url: "{{ env('URL_API') }}/api/v1/additionalinformation/" + guid,
                    data: {
