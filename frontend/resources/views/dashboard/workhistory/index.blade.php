...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light"></span> Work History
        </h4>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#table-data').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url": "{{ env('URL_API') }}/api/v1/workhistory/datatable",
                    "type": "GET",
                ...
                "columns": [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            return '<a href="/workhistory/edit/' + data['guid'] + '" class="btn btn-sm btn-icon item-edit"><i class="text-primary ti ti-pencil"></i></a>' +
                ...
                buttons: [{
                    ...
                    action: function(e, dt, node, config) {
                        window.location = 'workhistory/insert';
                    }
                }],
                responsive: {
                    details: {
            ...
            }), $("div.head-label").html('<h5 class="card-title mb-0">Work History Data</h5>');
            ...
            $('#delete-form').on('submit', function(e) {
                ...
                $.ajax({
                    type: "DELETE",
                    url: "{{ env('URL_API') }}/api/v1/workhistory/" + guid,
                    data: {
