...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Product / Product Tag /</span> Edit</h4>
        <!-- Basic Layout -->
        <div class="row" id="card-block">
            <div class="col-xl">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Edit Form Product Tag</h5>
                    </div>
                    <div class="card-body">
                        <form id="form">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="product-tag-name"
                                    ...
                                    value="{{ $data['data']['product_tag_name'] }}" />
                            </div>
                            <div class="mb-3">
