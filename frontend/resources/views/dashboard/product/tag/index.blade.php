...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">Product /</span> Product Tag
        </h4>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#table-data').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url": "{{ env('URL_API') }}/api/v1/product-tag/datatable",
                    "type": "GET",
                ...
                "columns": [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            ...
                            @isPermissions('Update_ProductTag')
                                actionsHtml += '<a href="/product-tag/edit/' + data['guid'] + '" class="btn btn-sm btn-icon item-edit"><i class="text-primary ti ti-pencil"></i></a>';
                            @endisPermissions

                            @isPermissions('Delete_ProductTag')
                ...
                buttons: [
                    {
                        ...
                        action: function(e, dt, node, config) {
                            @isPermissions('Create_ProductTag')
                            window.location = 'product-tag/insert';
                            @endisPermissions
                        }
                    }
                ],
            ...
            }), $("div.head-label").html('<h5 class="card-title mb-0">Product Tag Data</h5>');
            ...
            $('#delete-form').on('submit', function(e) {
                ...
                $.ajax({
                    type: "DELETE",
                    url: "{{ env('URL_API') }}/api/v1/product-tag/" + guid,
                    data: {
                    ...
                    success: function(result) {
                        ...
                        toastr.options.onHidden = function() {
                            window.location.href = "{{ route('index-product-tag') }}";
                        }
                        toastr.success(
