...
@section('title', 'Insert Product Tag')
...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Product / Product Tag /</span> Insert</h4>
        <!-- Basic Layout -->
        <div class="row" id="card-block">
            <div class="col-xl">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Insert Form Product Tag</h5>
                    </div>
                    <div class="card-body">
                        <form id="form">
                            <div class="mb-3">
                                <label class="form-label" for="basic-default-fullname">Product Tag Name</label>
                                <input type="text" class="form-control" id="product-tag-name"
                                    placeholder="Input Product Tag Name" required />
                            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#form').on('submit', function(e) {
                ...
                var productTagName = $('#product-tag-name').val();
