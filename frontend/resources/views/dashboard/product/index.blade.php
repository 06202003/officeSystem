                ...
                "columns": [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            ...
                            @isPermissions('Update_Product')
                                buttons += '<a href="/product/edit/' + data['guid'] + '" class="btn btn-sm btn-icon item-edit"><i class="text-primary ti ti-pencil"></i></a>';
                            @endisPermissions

                            @isPermissions('Delete_Product')
                            ...
                            buttons += '<a href="' + data['preview_link'] + '" class="btn btn-sm btn-icon" target="_BLANK"><i class="text-primary ti ti-external-link"></i></a>';
                            buttons += '<a href="' + data['download_link'] + '" class="btn btn-sm btn-icon" target="_BLANK"><i class="text-primary ti ti-cloud-download"></i></a>';
