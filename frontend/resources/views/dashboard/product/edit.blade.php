            ...
            <div class="col-xl">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Edit Form Product</h5>
                    </div>
                    <div class="card-body">
                        <form id="form">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="product-name"
                                    placeholder="Input Product Name" required value="{{ $data['data']['product_name'] }}" />
                            </div>
                            <div class="mb-3">
                                <label class="form-label" for="basic-default-fullname">Description</label>
                                <textarea class="form-control" rows="3" id="description" required placeholder="Description">{{ $data['data']['description'] }}</textarea>
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" class="form-control" id="link-google-drive"
                                        placeholder="Link Google Drive" value="{{ $data['data']['preview_link'] }}">
                                </div>
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    // var currentTags = '{{ $productTags }}';
                    // currentTags = JSON.parse(currentTags.replace(/&quot;/g, '"'));
                    // a.addTags(currentTags);
