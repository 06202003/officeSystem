...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">Users / User Configuration /</span> Position
        </h4>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#table-data').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url": "{{ env('URL_API') }}/api/v1/position/datatable",
                    "type": "GET",
                ...
                "columns": [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            ...
                            @isPermissions('Update_Position')
                                actionsHtml += '<a href="/position/edit/' + data['guid'] + '" class="btn btn-sm btn-icon item-edit"><i class="text-primary ti ti-pencil"></i></a>';
                            @endisPermissions

                            @isPermissions('Delete_Position')
            ...
            }), $("div.head-label").html('<h5 class="card-title mb-0">Position Data</h5>');
            ...
            $('#delete-form').on('submit', function(e) {
                ...
                $.ajax({
                    type: "DELETE",
                    url: "{{ env('URL_API') }}/api/v1/position/" + guid,
                    data: {
                    ...
                    success: function(result) {
                        ...
                        toastr.options.onHidden = function() {
                            window.location.href = "{{ route('index-position') }}";
                        }
                        toastr.success(
