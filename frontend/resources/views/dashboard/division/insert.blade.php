...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Users / User Configuration / Division /</span>
            Insert</h4>
        <!-- Basic Layout -->
            ...
            <div class="col-xl">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Insert Form Division</h5>
                    </div>
                    <div class="card-body">
                        <form id="form">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label class="form-label" for="basic-default-fullname">Division Name</label>
                                <input type="text" class="form-control" id="division-name"
                                    placeholder="Input Division Name" required />
                            </div>
                            @isPermissions('Create_Division')
