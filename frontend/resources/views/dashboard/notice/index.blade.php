...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">CMS /</span> Notice
        </h4>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#table-data').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url": "{{ env('URL_API') }}/api/v1/notice/datatable",
                    "type": "GET",
                ...
                "columns": [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            ...
                            @isPermission('Update_Notice')
                                buttons += '<a href="/notice/edit/' + data['guid'] + '" class="btn btn-sm btn-icon item-edit"><i class="text-primary ti ti-pencil"></i></a>';
                            @endisPermission

                            buttons += '<a href="' + data['url'] + '" target="_BLANK" class="btn btn-sm btn-icon item-edit"><i class="text-primary ti ti-link"></i></a>';

                            @isPermission('Delete_Notice')
                                buttons += '<button data-bs-toggle="modal" data-bs-target="#modalDelete" data-guid="' + data['guid'] + '" class="btn btn-sm btn-icon item-edit open-delete-dialog"><i class="text-primary ti ti-trash"></i></button>';
                            @endisPermission
            ...
            }), $("div.head-label").html('<h5 class="card-title mb-0">Notice Data</h5>');
            ...
            $('#delete-form').on('submit', function(e) {
                ...
                $.ajax({
                    type: "DELETE",
                    url: "{{ env('URL_API') }}/api/v1/notice/" + guid,
                    data: {
