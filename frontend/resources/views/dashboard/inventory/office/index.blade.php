...
<h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Inventory /</span> Office
    </h4>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#table-data').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "{{ env('URL_API') }}/api/v1/office/datatable/",
                "type": "GET",
            ...
            "columns": [
                ...
                },
                {
                    ...
                    if (data.startsWith('0')) {
                        return '+62 ' + data.substr(1, 4) + '-' + data.substr(5, 4) + '-' + data.substr(9);
                    } else if (data.startsWith('8')) {
                        return '+62 ' + data.substr(0, 4) + '-' + data.substr(5, 4) + '-' + data.substr(9);
                    } else if (data.startsWith('62')) {
                        return '+62 ' + data.substr(2, 4) + '-' + data.substr(5, 4) + '-' + data.substr(9);
                    } else {
                        return data;
                    }
                }
                ...
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        ...
                        @isPermissions('Update_Office')
                            actionsHtml += '<a href="/office/edit/' + data['guid'] + '" class="btn btn-sm btn-icon item-edit"><i class="text-primary ti ti-pencil"></i></a>';
                        @endisPermissions

                        @isPermissions('Delete_Office')
            ...
            buttons: [{
                ...
                action: function(e, dt, node, config) {
                    @isPermissions('Create_Office')
                    window.location = 'office/insert';
                    @endisPermissions
                }
            }],
            responsive: {
        ...
        }), $("div.head-label").html('<h5 class="card-title mb-0">Data Office</h5>');
        ...
        $('#delete-form').on('submit', function(e) {
            ...
            $.ajax({
                type: "DELETE",
                url: "{{ env('URL_API') }}/api/v1/office/" + guid,
                data: {
