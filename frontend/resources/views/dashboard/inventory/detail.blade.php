                ...
                <div class="col-6 col-sm-12">
                    <div class="card mb-5">
                        <div class="card-header header-elements p-3 my-n1">
                            <h5 class="card-title mb-0 pl-0 pl-sm-2 p-2">Bar Chart Book Value
                                {{ $inventory['data']['inventory_name'] }}</h5>
                        </div>
                        <div class="card-body">
                ...
                <!-- <div class="col-6 col-sm-4">
                    <div class="card">
                        <div class="card-header header-elements">
                            <h5 class="card-title mb-0">Total Damaged</h5>
                        </div>
                        <div class="card-body">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <ul class="list-unstyled mb-4 mt-3">
                                    <li class="d-flex align-items-center mb-3 "><i class="fa fa-tag"></i><span
                                            class="fw-bold mx-2">Inventory Name:</span>
                                    ...
                                    <li class="d-flex align-items-center mb-3"><i class="fa fa-bars"></i><span
                                            class="fw-bold mx-2">Category:</span>
                            ...
                            <div class="col-md-6">
                                <ul class="list-unstyled mb-4 mt-3">
                                    <li class="d-flex align-items-center mb-3"><i class="fa fa-check"></i><span
                                    ...
                                    <li class="d-flex align-items-center mb-3"><i class="fa fa-clock-o"></i><span
                                            class="fw-bold mx-2">Useful Life:</span>
                                    ...
                                    <li class="d-flex align-items-center mb-3"><i class="fa fa-trash-o"></i><span
                                            class="fw-bold mx-2">Residual Value:</span>
                                    ...
                                    <li class="d-flex align-items-center mb-3"><i class="fa fa-line-chart"></i><span
                                            class="fw-bold mx-2">Depreciation:
                                    ...
                                    <li class="d-flex align-items-center mb-3"><i class="fa fa-minus"></i><span
                                            class="fw-bold mx-2">First Year Value:</span>
                                    ...
                                    <li class="d-flex align-items-center mb-3"><i class="fa fa-minus"></i><span
                                            class="fw-bold mx-2">Second Year Value:</span>
                                    ...
                                    <li class="d-flex align-items-center mb-3"><i class="fa fa-minus"></i><span
                                            class="fw-bold mx-2">Third Year Value:</span>
                                    ...
                                    <li class="d-flex align-items-center mb-3"><i class="fa fa-minus"></i><span
                                            class="fw-bold mx-2">Fourth Year Value:</span>
            ...
            $(document).ready(function() {
                        ...
                        if (barChart) {
                            const barChartVar = new Chart(barChart, {
                                ...
                                data: {
                                    ...
                                    datasets: [{
                                        data: [result.data.price_in_year_1, result.data
                                            .price_in_year_2, result.data
                                            .price_in_year_3, result.data
                                            .price_in_year_4
                                        ],
                ...
                if (polarChart) {
                    const polarChartVar = new Chart(polarChart, {
                        type: 'polarArea',
                        data: {
                            labels: ['Normal', 'Maintenance', 'Damaged'],
                            datasets: [{
                                label: 'Population (millions)',
                                backgroundColor: [greenColor, orangeColor, redColor],
                                data: [19, 17.5, 15],
                                borderWidth: 0
                            }]
                        },
