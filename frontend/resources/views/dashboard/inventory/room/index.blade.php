...
<h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Inventory /</span> Room
    </h4>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#table-data').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "{{ env('URL_API') }}/api/v1/room/datatable/",
                "type": "GET",
            ...
            "columns": [
                ...
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        ...
                        @isPermissions('Update_Room')
                            actionsHtml += '<a href="/room/edit/' + data['guid'] + '" class="btn btn-sm btn-icon item-edit"><i class="text-primary ti ti-pencil"></i></a>';
                        @endisPermissions

                        @isPermissions('Delete_Room')
            ...
            buttons: [{
                ...
                action: function(e, dt, node, config) {
                    @isPermissions('Create_Room')
                    window.location = 'room/insert';
                    @endisPermissions
                }
            }],
            responsive: {
        ...
        }), $("div.head-label").html('<h5 class="card-title mb-0">Data Room</h5>');
        ...
        $('#delete-form').on('submit', function(e) {
            ...
            $.ajax({
                type: "DELETE",
                url: "{{ env('URL_API') }}/api/v1/room/" + guid,
                data: {
