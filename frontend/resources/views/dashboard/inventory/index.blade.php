...
@section('vendor-css')
    ...
    <link rel="stylesheet"
        href="{{ asset('./assets/new-dashboard/vendor/libs/datatables-bs5/datatables.bootstrap5.css') }}">
    <link rel="stylesheet"
        href="{{ asset('./assets/new-dashboard/vendor/libs/datatables-responsive-bs5/responsive.bootstrap5.css') }}">
    <link rel="stylesheet"
        href="{{ asset('./assets/new-dashboard/vendor/libs/datatables-checkboxes-jquery/datatables.checkboxes.css') }}">
...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">Inventory /</span> Item
        </h4>
...
@section('custom-javascript')
    <script type="text/javascript">
        $(document).ready(function() {
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            if (data == "normal") {
                                ...
                                return '<span class="badge bg-label-danger">Maintenance</span>';
                            } else {
                    ...
                    details: {
                        ...
                        renderer: function(e, t, a) {
                            a = $.map(a, function(e, t) {
                                return "" !== e.title ?
                                    '<tr data-dt-row="' + e.rowIndex + '" data-dt-column="' + e
                                    .columnIndex + '"><td>' + e.title + ":</td> <td>" + e.data +
                                    "</td></tr>" : ""
                            }).join("");
            ...
            // Set DataTable header label
            $("div.head-label").html('<h5 class="card-title mb-0">Data Item</h5>');

            // Open delete dialog on button click
