...
<h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Inventory /</span> Damage History
    </h4>
            ...
            <table class="table table-responsive" id="table-data">
                <thead>
                    <tr>
                        ...
                        <th>Completion Date of Repair</th>
                        <th>Repair Vendor</th>
                        <th>User Repair</th>
                        <th>User Last</th>
                        <th>Action</th>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#table-data').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "{{ env('URL_API') }}/api/v1/damage-history/datatable",
                "type": "GET",
            ...
            "columns": [
                ...
                },
                {
                    ...
                    title: "Actions",
                    render: function(data, type, full, meta) {
                        return '<a href="/all_damage_history/edit/' + data['guid'] +
            ...
            buttons: [{
                ...
                action: function(e, dt, node, config) {
                    window.location = 'all_damage_history/insert';
                }
            }],
            responsive: {
                details: {
        ...
        }), $("div.head-label").html('<h5 class="card-title mb-0">Data Damage History</h5>');
