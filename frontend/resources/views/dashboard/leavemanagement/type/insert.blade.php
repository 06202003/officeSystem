...
@section('title', 'Insert Leave Type')
...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Leave Management / Leave Types /</span>
            Insert</h4>
        <!-- Basic Layout -->
            ...
            <div class="col-xl">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Insert Leave Type</h5>
                    </div>
                    <div class="card-body">
                        <form id="form">
                            <div class="mb-3">
                                <label class="form-label" for="basic-default-fullname">Leave Type</label>
                                <input type="text" class="form-control" id="name" placeholder="Enter Leave Type" required />
                            </div>
                            <div class="mb-3">
                            ...
                            <!-- <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="duration"
                                    placeholder="Enter Duration (e.g., 1 day, 2 weeks)" required />
                            </div> -->
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#form').on('submit', function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ env('URL_API') }}/api/v1/leave-type",
                    data: {
                        "name": leaveType,
