...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">Types of Leave and Details</span>
        </h4>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#table-data').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url": "{{ env('URL_API') }}/api/v1/leave-type/datatable/",
                    "type": "GET",
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            var actionsHtml = '';
                                ...
                                actionsHtml += '<a href="/leave-type/edit/' + data['guid'] + '" class="btn btn-sm btn-icon item-edit"><i class="text-primary ti ti-pencil"></i></a>';
                ...
                buttons: [
                        {
                            ...
                            action: function(e, dt, node, config) {
                                window.location = 'leave-type/insert';
                            }
                        }
                ],
                responsive: {
            ...
            }), $("div.head-label").html('<h5 class="card-title mb-0">Leave Type Data</h5>');
            ...
            $('#delete-form').on('submit', function(e) {
                ...
                $.ajax({
                    type: "DELETE",
                    url: "{{ env('URL_API') }}/api/v1/leave-type/" + guid,
                    data: {
                    ...
                    success: function(result) {
                        ...
                        toastr.options.onHidden = function() {
                            window.location.href = "{{ route('index-leave-type') }}";
                        }
                        toastr.success(
