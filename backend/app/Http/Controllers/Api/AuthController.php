...
class AuthController extends Controller
{
    ...
    public function loginAdmin(Request $request)
    {
        ...
        // $user = User::select('users.guid', 'users.name', 'users.email', 'users.phone_number', 'users.password', 'model_has_roles.role_guid', 'roles.name')
        //     ->join('model_has_roles', 'model_has_roles.model_guid', '=', 'users.guid')
        //     ->join('roles', 'roles.guid', '=', 'model_has_roles.role_guid')
        //     ->where([
